...
Built a <MagicLink invertColor text="CashApp clone" url="https://github.com/casprine/cashapp"/> and a <MagicLink invertColor text="Clubhouse UI clone" url="https://github.com/casprine/clubhouse-clone" /> with it.
